...
function Signin (props) {
  ...
  <form method='POST' className='grid grid-cols-2 gap-4'>
      ...
      <label htmlFor="signin_mdp2">Password (2)</label><input type="password" id="signin_mdp2" className={css} onChange={getPass2}/>
      <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' onClick={submissionHandler}>Sign In</button><button type="reset" className='bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded'>Reset</button>      
