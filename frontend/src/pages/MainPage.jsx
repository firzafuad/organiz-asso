function MainPage() {
    return (
        ...
        <div id="logo" className="w-1/4 h-24">
            <image src="../assets/Logo_SU.png" className="m-4" alt="Logo de l'association" id="logo_image" />
        </div>
        <div id="search" className="w-1/2 h-24">
            <form id="search_form">
            <input id="requete" placeholder="Rechercher..."/>
        ...
        <div id="connect" className="w-1/4 h-24 bg-green-500"><a href="connexion.html" id="connection_link">Connexion</a>&nbsp;<a href="enregistrement.html" id="register_link">Enregistrement</a></div>
        </header>
        <main className="flex w-full">
        <aside className="w-1/5 bg-red-500"></aside>
        <section className="flex w-4/5 flex-col">
            <div id="new_comment" className="w-full h-24 bg-yellow-500">
            ...
            <article className="w-full bg-cyan-500">
            <ul>
                <li>
